...
const GRADE_CONFIG = {
  'A+': {
    ...
    description: 'Eco-Champion — Ultra Low Carbon Emission',
    icon: Award,
  },
  'A': {
    ...
    description: 'Great Performance — Well Optimized & Sustainable',
    icon: ShieldCheck,
  },
  'B': {
    ...
    description: 'Good — Cleaner than majority of the web',
    icon: Leaf,
  },
  'C': {
    ...
    description: 'Average — Moderate Carbon Emissions',
    icon: AlertTriangle,
  },
  'D': {
    ...
    description: 'Below Average — Significant optimization potential',
    icon: AlertTriangle,
  },
  'E': {
    ...
    description: 'Heavy — High Carbon Footprint',
    icon: AlertTriangle,
  },
  'F': {
    ...
    description: 'Critical — Excessive Data Weight & Emissions',
    icon: AlertTriangle,
  },
};
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 glass-panel rounded-3xl relative overflow-hidden text-center group">
      ...
      <div className="relative mb-4">
        ...
        >
          ...
          <span className="text-xs font-mono text-slate-300 mt-1 font-medium">
            {carbonGrams}g <span className="text-[10px] text-slate-400">CO2 / visit</span>
          </span>
        </div>
      </div>
      ...
      <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-slate-900/90 border border-emerald-500/30 text-xs text-white mb-2 shadow-sm">
        ...
        <span>
          Cleaner than <strong className="text-emerald-300 font-extrabold">{cleanerThan}%</strong> of web pages
        </span>
      </div>
